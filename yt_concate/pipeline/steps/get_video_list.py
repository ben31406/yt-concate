    ...
    def process(self, data, inputs, utils):
        ...
        while True:
            ...
            try:
                ...
                break
        logger.info('Get total video links：' + str(len(video_links)))
        self.write_to_file(video_links[:15], utils.get_video_list_filepath(channel_id))
        return video_links[:15]
